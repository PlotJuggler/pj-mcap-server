...
//   customer=globex/customer_site=nashville/robot=arri-182/source=ros-bags/date=2026-05-19/rosbox_2026-05-19_16-43-46.mcap
// which is long and noisy. The displayed name strips it down to just the
// values, slash-separated:
//   globex/nashville/arri-182/ros-bags/rosbox_2026-05-19_16-43-46.mcap
