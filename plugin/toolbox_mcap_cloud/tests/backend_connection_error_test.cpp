...
//
// Registered as McapCloudBackendErrorTest; runs in the hermetic CI suite.
...
TEST(McapCloudBackendError, ConnectClosedPortFailsWithUrlInError) {
  mcap_cloud::BackendConnection conn(kClosedPortUrl, /*cert_path=*/"", /*api_key=*/"",
...
TEST(McapCloudBackendError, ListOnNeverConnectedReturnsEmpty) {
