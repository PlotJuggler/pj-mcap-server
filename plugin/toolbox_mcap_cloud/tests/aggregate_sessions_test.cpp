...
using mcap_cloud::AggInput;
using mcap_cloud::aggregateSessions;
using mcap_cloud::partitionKey;
...
TEST(PartitionKey, DropsFilenameAndDateSegment) {
  EXPECT_EQ(partitionKey("customer=globex/customer_site=nashville/robot=arri-182/source=ros-bags/"
                         "date=2026-05-19/rosbox_2026-05-19_16-43-46.mcap"),
            "customer=globex/customer_site=nashville/robot=arri-182/source=ros-bags");
}
