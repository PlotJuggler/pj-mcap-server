...
using dexory_cloud::shortenSequenceName;
...
TEST(SeqDisplay, StripsHivePrefixesAndDateFromRealKey) {
  ...
  EXPECT_EQ(shortenSequenceName(key), "dexory/nashville/arri-182/ros-bags/rosbox_2026-05-19_16-43-46.mcap");
}
...
TEST(SeqDisplay, StripsKeyPrefixKeepingValue) {
  EXPECT_EQ(shortenSequenceName("customer=dexory/file.mcap"), "dexory/file.mcap");
